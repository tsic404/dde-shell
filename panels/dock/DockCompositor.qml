...
Item {
    ...
    function removeSpecialObject(model, object) {
    ...
    WaylandCompositor {
        ...
        DockPluginManager {
            ...
            onPluginSurfaceDestoried: (dockPluginSurface) => {
                switch(dockPluginSurface.surfaceType) {
                case DockPluginManager.Tooltip: {
                ...
                case DockPluginManager.Tray: {
                    removeSpecialObject(dockCompositor.trayPluginSurfaces, dockPluginSurface)
                    break
                }
                case DockPluginManager.Fixed: {
                    removeSpecialObject(dockCompositor.fixedPluginSurfaces, dockPluginSurface)
                    break
                }
                case DockPluginManager.System: {
                    removeSpecialObject(dockCompositor.systemPluginSurfaces, dockPluginSurface)
                    break
                }
                case DockPluginManager.Tool: {
                    removeSpecialObject(dockCompositor.toolPluginSurfaces, dockPluginSurface)
                    break
                }
                case DockPluginManager.Quick: {
                    removeSpecialObject(dockCompositor.quickPluginSurfaces, dockPluginSurface)
                    break
                }
                case DockPluginManager.SlidingPanel: {
                    removeSpecialObject(dockCompositor.slidingPanelPluginSurfaces, dockPluginSurface)
                    break
                }
                }
            }
